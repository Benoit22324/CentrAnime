...
import AniListRepository from "../../infrastructure/repositories/AniListRepository";
import { redisCachingMiddleware } from "../middlewares/redisMiddleware";

const aniListRepository = new AniListRepository();
const animeRepository = new AnimeRepository();
const getAnimesByPageUseCase = new GetAnimesByPageUseCase(animeRepository, aniListRepository);
